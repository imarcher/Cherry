...
// Maximum number of keys stored in a node. UP in the paper.
#define Leaf_maxnum 512
//#define Leaf_maxnum (int)(128* 0.82)

// Minimum number of keys stored in a node. LP in the paper.
#define Leaf_minnum (Leaf_maxnum/2)

// Number of memtables (Number of insert threads)
#define pool_size 1

// Number of time series inserted in the initialization process. Please ensure that the input file has sufficient time series.
